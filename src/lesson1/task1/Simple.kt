 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = seconds(grad, min, sec) * PI / 180 / 3600
 ...
 */
fun thirdDigit(number: Int): Int = (number - (number / 1000) * 1000 - number % 100) / 100
...
fun account(initial: Double, percent : Int) : Double = initial * (1 + percent / 100.0)

fun accountInThreeYears(initial: Int, percent: Int): Double {
    var accountSum = initial.toDouble()
    for (i in 0..2)
        accountSum = account(accountSum, percent)
    return accountSum
}
